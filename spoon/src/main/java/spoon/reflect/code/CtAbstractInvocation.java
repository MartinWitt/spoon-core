...
public interface CtAbstractInvocation extends CtElement {
	...
	<C extends CtAbstractInvocation> C addArgument(CtExpression argument);
	 ...
	 */
	@PropertySetter(role = ARGUMENT)
	<C extends CtAbstractInvocation> C addArgumentAt(int position, CtExpression argument);
	 ...
	 */
	@PropertySetter(role = ARGUMENT)
	<C extends CtAbstractInvocation> C setArguments(List<CtExpression> arguments);
	...
	<C extends CtAbstractInvocation> C setExecutable(CtExecutableReference executable);
}
