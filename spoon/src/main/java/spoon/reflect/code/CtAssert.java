 ...
 */
public interface CtAssert extends CtStatement {
	/**
	...
	<A extends CtAssert> A setAssertExpression(CtExpression asserted);
	...
	<A extends CtAssert> A setExpression(CtExpression expression);
