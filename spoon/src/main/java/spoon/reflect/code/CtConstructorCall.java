 ...
 * 		created type
 */
public interface CtConstructorCall extends CtTargetedExpression, CtAbstractInvocation, CtStatement, CtActualTypeContainer {/**
	...
	@Override
	@DerivedProperty
	@spoon.reflect.annotations.PropertyGetter(role = TYPE_ARGUMENT)
	 ...
	 */
	@Override
	@spoon.reflect.annotations.PropertySetter(role = TYPE_ARGUMENT)
	...
	@Override
	@DerivedProperty
	@spoon.reflect.annotations.PropertyGetter(role = TYPE)
