 ...
 */
public interface CtLocalVariable extends CtStatement, CtVariable, CtRHSReceiver, CtResource {/* (non-Javadoc)
	...
	<U extends CtLocalVariable> U setInferred(boolean inferred);
