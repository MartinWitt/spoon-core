 ...
 */
public interface CtAnnotationMethod extends CtMethod {
	/**
	...
	<C extends CtAnnotationMethod> C setDefaultExpression(CtExpression assignedExpression);
	...
	@Override
	@UnsettableProperty
	<T1 extends CtExecutable> T1 setThrownTypes(Set<CtTypeReference> thrownTypes);
	...
	@Override
	@UnsettableProperty
	<T1 extends CtExecutable> T1 setParameters(List<CtParameter> parameters);
}
