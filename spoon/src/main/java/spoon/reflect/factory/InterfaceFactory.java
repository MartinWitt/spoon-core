...
public class InterfaceFactory extends TypeFactory {
	 ...
	 */
	public <T> CtInterface create(CtPackage owner, String simpleName) {
		CtInterface i = factory.Core().createInterface();
	 ...
	 */
	public <T> CtInterface create(CtType owner, String simpleName) {
		CtInterface ctInterface = factory.Core().createInterface();
	...
	public <T> CtInterface create(String qualifiedName) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public <T> CtInterface get(String qualifiedName) {
		try {
	...
	@Override
	@SuppressWarnings("unchecked")
	public <T> CtInterface get(Class<?> cl) {
		try {
