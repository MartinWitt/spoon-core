...
public class ForceImportProcessor extends ImportAnalyzer<LexicalScope> {@Override
	...
	protected void handleTypeReference(CtTypeReference reference, LexicalScope nameScope, CtRole role) {
		if (reference.getPackage() != null) {
			...
			CtType contextType = reference.getParent(spoon.reflect.declaration.CtType.class);
			if (contextType != null) {
