...
public class CtAssertImpl extends CtStatementImpl implements CtAssert {
	private static final long serialVersionUID = 1L;

	@MetamodelPropertyField(role = CONDITION)
	CtExpression asserted;
	...
	@Override
	public <A extends CtAssert> A setAssertExpression(CtExpression asserted) {
		if (asserted != null) {
	...
	@Override
	public <A extends CtAssert> A setExpression(CtExpression value) {
		if (value != null) {
	...
	@Override
	public CtAssert clone() {
		return ((CtAssert) (super.clone()));
	}
}
