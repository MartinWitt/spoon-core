...
public class CtCatchVariableImpl extends CtCodeElementImpl implements CtCatchVariable {
	...
	@Override
	public CtCatchVariableReference getReference() {
	...
	public CtTypeReference getType() {
		if (types.isEmpty()) {
			...
			if (types.size() == 1) {
				return ((CtTypeReference) (types.get(0)));
			}
		}
		...
		return ((CtTypeReference) (superTypesOfFirst.get(commonSuperTypeIdx)));
	}
	...
	@Override
	public CtCatchVariable clone() {
		return ((CtCatchVariable) (super.clone()));
	}
