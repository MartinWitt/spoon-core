 ...
 */
public class CtAnnotationImpl extends CtExpressionImpl implements CtAnnotation {
	...
	@Override
	public <T extends CtAnnotation> T addValue(String elementName, Object value) {
	...
	private CtExpression convertValueToExpression(Object value) {
		...
		if (value.getClass().isArray()) {
			...
			CtFieldReference variable = getFactory().Field().createReference((Field) value);
	...
	private <T extends CtAnnotation> T addValueExpression(String elementName, CtExpression expression) {
	...
	@Override
	public <T extends CtAnnotation> T addValue(String elementName, CtLiteral<?> value) {
		return addValueExpression(elementName, value);
	}

	@Override
	public <T extends CtAnnotation> T addValue(String elementName, CtNewArray value) {
		return addValueExpression(elementName, value);
	}

	@Override
	public <T extends CtAnnotation> T addValue(String elementName, CtFieldAccess value) {
		return addValueExpression(elementName, value);
	}

	@Override
	public <T extends CtAnnotation> T addValue(String elementName, CtAnnotation value) {
		return addValueExpression(elementName, value);
	}
	...
	@Override
	@SuppressWarnings("unchecked")
	public <T extends CtAnnotation> T setAnnotationType(CtTypeReference annotationType) {
		...
		this.annotationType = ((CtTypeReference) (annotationType));
		return ((T) (this));
	}

	@Override
	public <T extends CtAnnotation> T setElementValues(Map<String, Object> values) {
	...
	@Override
	public <T extends CtAnnotation> T setValues(Map<String, CtExpression> values) {
		getFactory().getEnvironment().getModelChangeListener().onMapDeleteAll(this, CtRole.VALUE, this.elementValues, new HashMap<>(elementValues));
		this.elementValues.clear();
	...
	public Annotation getActualAnnotation() {
		class AnnotationInvocationHandler implements InvocationHandler {
			...
			AnnotationInvocationHandler(CtAnnotation annotation) {
		...
		return ((Annotation) (Proxy.newProxyInstance(annotationType.getActualClass().getClassLoader(), new Class[]{ annotationType.getActualClass() }, new AnnotationInvocationHandler(this))));
	}
	...
	@Override
	@UnsettableProperty
	public <C extends CtExpression> C setTypeCasts(List<CtTypeReference> casts) {
		return ((C) (this));
	}
