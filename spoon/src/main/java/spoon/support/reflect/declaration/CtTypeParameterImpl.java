...
public class CtTypeParameterImpl extends CtTypeImpl implements CtTypeParameter {
	...
	public boolean isSubtypeOf(CtTypeReference superTypeRef) {
		if (superTypeRef instanceof CtTypeParameterReference) {
			...
			if (getTypeParameterDeclarer() instanceof CtType) {
				...
				if (getTypeParameterDeclarer() instanceof CtMethod) {
					typeAdaptor = new TypeAdaptor(((CtMethod) (getTypeParameterDeclarer())));
				} else {
					if (getTypeParameterDeclarer() instanceof CtConstructor) {
