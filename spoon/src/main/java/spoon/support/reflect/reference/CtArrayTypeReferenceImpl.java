...
public class CtArrayTypeReferenceImpl extends CtTypeReferenceImpl implements CtArrayTypeReference {
	...
	@Override
	public <C extends CtArrayTypeReference> C setComponentType(CtTypeReference componentType) {
		if (componentType != null) {
			componentType.setParent(this);
		}
	...
	@Override
	public CtArrayTypeReference clone() {
	...
	@Override
	public CtArrayTypeReferenceImpl setSimplyQualified(boolean isSimplyQualified) {
		if (componentType != null) {
	 ...
	 */
	public <C extends CtArrayTypeReference> C setDeclarationKind(DeclarationKind declarationKind) {
	...
	public DeclarationKind getDeclarationKind() {
		return ((DeclarationKind) (this.getMetadata(spoon.support.reflect.reference.CtArrayTypeReferenceImpl.DeclarationKind.class.getSimpleName())));
	}
