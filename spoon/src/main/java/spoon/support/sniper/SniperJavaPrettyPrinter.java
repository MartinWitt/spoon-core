...
public class SniperJavaPrettyPrinter extends DefaultJavaPrettyPrinter implements TokenWriterProxy.Listener {
	...
	public void calculate(CtCompilationUnit compilationUnit, List<CtType> types) {
		...
		runInContext(new SourceFragmentContextList(mutableTokenWriter, compilationUnit, Collections.singletonList(compilationUnit.getOriginalSourceFragment()), new ChangeResolver(getChangeCollector(), compilationUnit)), () -> {
