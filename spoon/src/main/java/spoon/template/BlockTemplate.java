...
public abstract class BlockTemplate extends AbstractTemplate<CtBlock> {
	 ...
	 * Returns the block.
	 */
	public static CtBlock getBlock(CtClass p) {
	...
	public CtBlock apply(CtType targetType) {
		...
		return TemplateBuilder.createTemplateBuilder(getBlock(c), this).setAddGeneratedBy(isAddGeneratedBy()).substituteSingle(targetType, spoon.reflect.code.CtBlock.class);
	}
