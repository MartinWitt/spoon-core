 ...
 */
public class ExtensionTemplate extends AbstractTemplate<CtType> {@Override
	public CtType apply(CtType target) {
		CtClass templateType = Substitution.getTemplateCtClass(target.getFactory(), this);
		CtType generated = TemplateBuilder.createTemplateBuilder(templateType, templateType, this).setAddGeneratedBy(isAddGeneratedBy()).substituteSingle(target, spoon.reflect.declaration.CtType.class);
