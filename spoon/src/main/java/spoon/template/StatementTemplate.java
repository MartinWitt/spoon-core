...
public abstract class StatementTemplate extends AbstractTemplate<CtStatement> {
	...
	public CtStatement apply(CtType targetType) {
		...
		List<CtStatement> statements = TemplateBuilder.createTemplateBuilder(patternModel, this).setAddGeneratedBy(isAddGeneratedBy()).substituteList(c.getFactory(), targetType, spoon.reflect.code.CtStatement.class);
