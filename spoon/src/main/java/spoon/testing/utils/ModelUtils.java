...
public final class ModelUtils {
	...
	public static <T> CtType buildClass(Class<T> classToBuild) throws Exception {
		return buildClass(classToBuild, true);
	}

	/** Builds and returns the Spoon model of `` classToBuild */
	public static <T> CtType buildClass(Class<T> classToBuild, boolean ensureFullclasspath) throws Exception {
	...
	public static <T> CtType buildClass(Consumer<Launcher> config, Class<T> classToBuild) throws Exception {
