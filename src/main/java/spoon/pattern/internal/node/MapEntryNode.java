...
public class MapEntryNode extends AbstractPrimitiveMatcher {
	...
	public <T> void generateTargets(DefaultGenerator generator, ResultHolder<T> result, ImmutableMap parameters) {
		String entryKey = generator.generateSingleTarget(key, parameters, java.lang.String.class);
		CtElement entryValue = generator.generateSingleTarget(value, parameters, spoon.reflect.declaration.CtElement.class);
