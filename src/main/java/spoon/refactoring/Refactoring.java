...
public final class Refactoring {
	...
	public static void changeTypeName(final CtType type, String name) {
		...
		final List<CtTypeReference> references = Query.getElements(type.getFactory(), new TypeFilter<CtTypeReference>(spoon.reflect.reference.CtTypeReference.class) {
			@Override
	...
	public static void changeMethodName(final CtMethod method, String newName) {
		...
		final List<CtExecutableReference> references = Query.getElements(method.getFactory(), new TypeFilter<CtExecutableReference>(spoon.reflect.reference.CtExecutableReference.class) {
			@Override
