 ...
 */
public interface CtExecutableReferenceExpression extends CtTargetedExpression {
	/**
	...
	<C extends CtExecutableReferenceExpression> C setExecutable(CtExecutableReference executable);
