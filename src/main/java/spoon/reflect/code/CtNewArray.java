 ...
 */
public interface CtNewArray extends CtExpression {

	/**
	 * Gets the expressions that define the array's dimensions.
	 */
	@PropertyGetter(role = DIMENSION)
	List<CtExpression> getDimensionExpressions();

	/**
	 * Sets the expressions that define the array's dimensions.
	 */
	@PropertySetter(role = DIMENSION)
	<C extends CtNewArray> C setDimensionExpressions(List<CtExpression> dimensions);

	/**
	 * Adds a dimension expression.
	 */
	@PropertySetter(role = DIMENSION)
	<C extends CtNewArray> C addDimensionExpression(CtExpression dimension);

	/**
	 * Removes a dimension expression.
	 */
	@PropertySetter(role = DIMENSION)
	boolean removeDimensionExpression(CtExpression dimension);
	...
	<C extends CtNewArray> C setElements(List<CtExpression> expression);

	/**
	 * Adds an element.
	 */
	@PropertySetter(role = EXPRESSION)
	<C extends CtNewArray> C addElement(CtExpression expression);
