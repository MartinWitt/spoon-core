 ...
 */
public interface CtTypeAccess extends CtExpression {
	/**
	...
	CtTypeReference getAccessedType();
	...
	<C extends CtTypeAccess> C setAccessedType(CtTypeReference accessedType);
