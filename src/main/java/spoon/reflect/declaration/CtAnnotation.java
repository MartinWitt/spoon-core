 ...
 */
public interface CtAnnotation extends CtExpression, CtShadowable {
	...
	<T extends CtAnnotation> T setAnnotationType(CtTypeReference type);
	...
	<T extends CtAnnotation> T setElementValues(Map<String, Object> values);
	 ...
	 */
	@PropertySetter(role = VALUE)
	<T extends CtAnnotation> T setValues(Map<String, CtExpression> values);
	 ...
	 */
	@PropertySetter(role = VALUE)
	<T extends CtAnnotation> T addValue(String elementName, Object value);

	/**
	 * Adds a new key-literal pair for this annotation.
	 */
	@PropertySetter(role = VALUE)
	<T extends CtAnnotation> T addValue(String elementName, CtLiteral<?> value);

	/**
	 * Adds a new key-array pair for this annotation.
	 */
	@PropertySetter(role = VALUE)
	<T extends CtAnnotation> T addValue(String elementName, CtNewArray value);

	/**
	 * Adds a new key-field access pair for this annotation.
	 */
	@PropertySetter(role = VALUE)
	<T extends CtAnnotation> T addValue(String elementName, CtFieldAccess value);

	/**
	 * Adds a new key-annotation pair for this annotation.
	 */
	@PropertySetter(role = VALUE)
	<T extends CtAnnotation> T addValue(String elementName, CtAnnotation value);
	...
	@Override
	@UnsettableProperty
	<C extends CtExpression> C setTypeCasts(List<CtTypeReference> types);
