...
public interface CtElement extends FactoryAccessor, CtVisitable, Cloneable, CtQueryable, Serializable, SourcePositionHolder {
	 ...
	 */
	@PropertyGetter(role = ANNOTATION)
	<A extends Annotation> CtAnnotation getAnnotation(
	 ...
	 */
	@PropertyGetter(role = ANNOTATION)
	List<CtAnnotation> getAnnotations();
	 ...
	 */
	@spoon.reflect.annotations.PropertyGetter(role = POSITION)
	@Override
	...
	<E extends CtElement> E addAnnotation(CtAnnotation annotation);
	 ...
	 */
	@PropertySetter(role = ANNOTATION)
	boolean removeAnnotation(CtAnnotation annotation);
	 ...
	 */
	@PropertySetter(role = ANNOTATION)
	<E extends CtElement> E setAnnotations(List<CtAnnotation> annotation);
