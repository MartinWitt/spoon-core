 ...
 * @see CtExecutable
 */
public interface CtParameter extends CtVariable, CtShadowable {/**
	...
	<C extends CtParameter> C setVarArgs(boolean varArgs);
	...
	@Override
	@UnsettableProperty
	<C extends CtVariable> C setDefaultExpression(CtExpression assignedExpression);
	...
	<U extends CtParameter> U setInferred(boolean inferred);
