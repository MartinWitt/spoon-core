 ...
 */
public interface CtType extends CtNamedElement, CtTypeInformation, CtTypeMember, CtFormalTypeDeclarer, CtShadowable {
	/**
	 ...
	 */
	@Override
	@spoon.reflect.annotations.PropertyGetter(role = NAME)
	...
	<F, C extends CtType> C addFieldAtTop(CtField field);
	 ...
	 */
	@PropertySetter(role = FIELD)
	<F, C extends CtType> C addField(CtField field);
	 ...
	 */
	@PropertySetter(role = FIELD)
	<F, C extends CtType> C addField(int index, CtField field);

	/**
	 * Sets all fields in the type.
	 */
	@PropertySetter(role = FIELD)
	<C extends CtType> C setFields(List<CtField> fields);
	 ...
	 */
	@PropertySetter(role = FIELD)
	<F> boolean removeField(CtField field);
	...
	<N, C extends CtType> C addNestedType(CtType nestedType);
	 ...
	 */
	@PropertySetter(role = NESTED_TYPE)
	<N> boolean removeNestedType(CtType nestedType);

	/**
	 * Sets all nested types.
	 */
	@PropertySetter(role = NESTED_TYPE)
	<C extends CtType> C setNestedTypes(Set<CtType> nestedTypes);
	...
	<R> CtMethod getMethod(CtTypeReference returnType, String name, CtTypeReference... parameterTypes);
	 ...
	 */
	@PropertyGetter(role = METHOD)
	<R> CtMethod getMethod(String name, CtTypeReference... parameterTypes);
	 ...
	 */
	@PropertySetter(role = METHOD)
	<M> boolean removeMethod(CtMethod method);
	 ...
	 */
	@PropertySetter(role = INTERFACE)
	<S, C extends CtType> C addSuperInterface(CtTypeReference interfac);
	 ...
	 */
	@PropertySetter(role = INTERFACE)
	<S> boolean removeSuperInterface(CtTypeReference interfac);
	...
	<C extends CtType> C addTypeMember(CtTypeMember member);
	 ...
	 */
	@PropertySetter(role = TYPE_MEMBER)
	<C extends CtType> C addTypeMemberAt(int position, CtTypeMember member);
	 ...
	 */
	@PropertySetter(role = TYPE_MEMBER)
	<C extends CtType> C setTypeMembers(List<CtTypeMember> members);
