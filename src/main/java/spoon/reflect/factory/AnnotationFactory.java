...
public class AnnotationFactory extends TypeFactory {
	...
	public <T extends Annotation> CtAnnotationType create(CtPackage owner, String simpleName) {
		CtAnnotationType t = factory.Core().createAnnotationType();
	 ...
	 */
	public <T extends Annotation> CtType getAnnotationType(String qualifiedName) {
	 ...
	 */
	public <A extends Annotation> CtAnnotation annotate(CtElement element, Class<A> annotationType,
	 ...
	 * @return the created/updated annotation
	 */
	public <A extends Annotation> CtAnnotation annotate(CtElement element, CtTypeReference annotationType, String annotationElementName, Object value) {
		final CtAnnotation annotation = annotate(element, annotationType);
		boolean isArray;
	 ...
	 * @return the concerned annotation
	 */
	public <A extends Annotation> CtAnnotation annotate(CtElement element, CtTypeReference annotationType) {
