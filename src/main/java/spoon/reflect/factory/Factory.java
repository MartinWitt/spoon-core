...
public interface Factory {
	 ...
	 */
	<A extends Annotation> CtAnnotation createAnnotation(CtTypeReference annotationType);

	/**
	 *  @see CodeFactory#createVariableAssignment(CtVariableReference,boolean, CtExpression)
	 */
	<A, T extends A> CtAssignment createVariableAssignment(CtVariableReference variable, boolean isStatic, CtExpression expression);

	/**
	 *  @see CodeFactory#createStatementList(CtBlock)
	 */
	<R> CtStatementList createStatementList(CtBlock block);
	 ...
	 */
	<T> CtBinaryOperator createBinaryOperator(CtExpression left, CtExpression right, BinaryOperatorKind kind);

	/**
	 *  @see CodeFactory#createCatchVariable(CtTypeReference,String, ModifierKind[])
	 */
	<T> CtCatchVariable createCatchVariable(CtTypeReference type, String name, ModifierKind... modifierKinds);

	/**
	 *  @see CodeFactory#createCodeSnippetExpression(String)
	 */
	<T> CtCodeSnippetExpression createCodeSnippetExpression(String expression);

	/**
	 *  @see CodeFactory#createConstructorCall(CtTypeReference,CtExpression[])
	 */
	<T> CtConstructorCall createConstructorCall(CtTypeReference type, CtExpression... parameters);

	/**
	 *  @see CodeFactory#createClassAccess(CtTypeReference)
	 */
	<T> CtFieldAccess createClassAccess(CtTypeReference type);

	/**
	 *  @see CodeFactory#createInvocation(CtExpression, CtExecutableReference, List)
	 */
	<T> CtInvocation createInvocation(CtExpression target, CtExecutableReference executable, List<CtExpression> arguments);

	/**
	 *  @see CodeFactory#createInvocation(CtExpression,CtExecutableReference,CtExpression[])
	 */
	<T> CtInvocation createInvocation(CtExpression target, CtExecutableReference executable, CtExpression... arguments);
	 ...
	 */
	<T> CtLocalVariable createLocalVariable(CtTypeReference type, String name, CtExpression defaultExpression);

	/**
	 *  @see CodeFactory#createLiteralArray(Object[])
	 */
	@SuppressWarnings(value = "unchecked")
	<T> CtNewArray createLiteralArray(T[] value);
	 ...
	 */
	<T> CtStatementList createVariableAssignments(List<? extends CtVariable> variables, List<? extends CtExpression> expressions);

	/**
	 *  @see CodeFactory#createThisAccess(CtTypeReference)
	 */
	<T> CtThisAccess createThisAccess(CtTypeReference type);

	/**
	 *  @see CodeFactory#createThisAccess(CtTypeReference,boolean)
	 */
	<T> CtThisAccess createThisAccess(CtTypeReference type, boolean isImplicit);

	/**
	 *  @see CodeFactory#createTypeAccess(CtTypeReference)
	 */
	<T> CtTypeAccess createTypeAccess(CtTypeReference accessedType);

	/**
	 *  @see CodeFactory#createTypeAccess(CtTypeReference,boolean)
	 */
	<T> CtTypeAccess createTypeAccess(CtTypeReference accessedType, boolean isImplicit);

	/**
	 *  @see CodeFactory#createTypeAccessWithoutCloningReference(CtTypeReference)
	 */
	<T> CtTypeAccess createTypeAccessWithoutCloningReference(CtTypeReference accessedType);

	/**
	 *  @see CodeFactory#createVariableRead(CtVariableReference,boolean)
	 */
	<T> CtVariableAccess createVariableRead(CtVariableReference variable, boolean isStatic);

	/**
	 *  @see CodeFactory#createVariableWrite(CtVariableReference,boolean)
	 */
	<T> CtVariableAccess createVariableWrite(CtVariableReference variable, boolean isStatic);

	/**
	 *  @see CodeFactory#createCtField(String,CtTypeReference,String,ModifierKind[])
	 */
	<T> CtField createCtField(String name, CtTypeReference type, String exp, ModifierKind... visibilities);

	/**
	 *  @see CodeFactory#createCatchVariableReference(CtCatchVariable)
	 */
	<T> CtCatchVariableReference createCatchVariableReference(CtCatchVariable catchVariable);

	/**
	 *  @see CodeFactory#createLocalVariableReference(CtLocalVariable)
	 */
	<T> CtLocalVariableReference createLocalVariableReference(CtLocalVariable localVariable);

	/**
	 *  @see CodeFactory#createLocalVariableReference(CtTypeReference,String)
	 */
	<T> CtLocalVariableReference createLocalVariableReference(CtTypeReference type, String name);

	/**
	 *  @see CodeFactory#createCtTypeReference(Class)
	 */
	<T> CtTypeReference createCtTypeReference(Class<?> originalClass);
	 ...
	 */
	<T> CtConstructor createDefault(CtClass target);

	/**
	 *  @see CoreFactory#createAnnotation()
	 */
	<A extends Annotation> CtAnnotation createAnnotation();

	/**
	 *  @see CoreFactory#createBlock()
	 */
	<R> CtBlock createBlock();

	/**
	 *  @see CoreFactory#createReturn()
	 */
	<R> CtReturn createReturn();
	 ...
	 */
	<S> CtSwitch createSwitch();

	/**
	 * @see CoreFactory#createSwitchExpression()
	 */
	<T, S> CtSwitchExpression createSwitchExpression();

	/**
	 *  @see CoreFactory#createEnum()
	 */
	<T extends Enum<?>> CtEnum createEnum();

	/**
	 *  @see CoreFactory#createAnnotationType()
	 */
	<T extends Annotation> CtAnnotationType createAnnotationType();

	/**
	 *  @see CoreFactory#createAssignment()
	 */
	<T, A extends T> CtAssignment createAssignment();

	/**
	 *  @see CoreFactory#createOperatorAssignment()
	 */
	<T, A extends T> CtOperatorAssignment createOperatorAssignment();

	/**
	 *  @see CoreFactory#createExecutableReferenceExpression()
	 */
	<T, E extends CtExpression> CtExecutableReferenceExpression createExecutableReferenceExpression();

	/**
	 *  @see CoreFactory#createAnnotationFieldAccess()
	 */
	<T> CtAnnotationFieldAccess createAnnotationFieldAccess();

	/**
	 *  @see CoreFactory#createArrayRead()
	 */
	<T> CtArrayRead createArrayRead();

	/**
	 *  @see CoreFactory#createArrayWrite()
	 */
	<T> CtArrayWrite createArrayWrite();

	/**
	 *  @see CoreFactory#createAssert()
	 */
	<T> CtAssert createAssert();

	/**
	 *  @see CoreFactory#createBinaryOperator()
	 */
	<T> CtBinaryOperator createBinaryOperator();

	/**
	 *  @see CoreFactory#createCatchVariable()
	 */
	<T> CtCatchVariable createCatchVariable();

	/**
	 *  @see CoreFactory#createCodeSnippetExpression()
	 */
	<T> CtCodeSnippetExpression createCodeSnippetExpression();

	/**
	 *  @see CoreFactory#createConditional()
	 */
	<T> CtConditional createConditional();

	/**
	 *  @see CoreFactory#createConstructorCall()
	 */
	<T> CtConstructorCall createConstructorCall();

	/**
	 *  @see CoreFactory#createFieldRead()
	 */
	<T> CtFieldRead createFieldRead();

	/**
	 *  @see CoreFactory#createFieldWrite()
	 */
	<T> CtFieldWrite createFieldWrite();

	/**
	 *  @see CoreFactory#createInvocation()
	 */
	<T> CtInvocation createInvocation();

	/**
	 *  @see CoreFactory#createLambda()
	 */
	<T> CtLambda createLambda();
	 ...
	 */
	<T> CtLocalVariable createLocalVariable();

	/**
	 *  @see CoreFactory#createNewArray()
	 */
	<T> CtNewArray createNewArray();

	/**
	 *  @see CoreFactory#createNewClass()
	 */
	<T> CtNewClass createNewClass();

	/**
	 *  @see CoreFactory#createSuperAccess()
	 */
	<T> CtSuperAccess createSuperAccess();

	/**
	 *  @see CoreFactory#createThisAccess()
	 */
	<T> CtThisAccess createThisAccess();

	/**
	 *  @see CoreFactory#createTypeAccess()
	 */
	<T> CtTypeAccess createTypeAccess();

	/**
	 *  @see CoreFactory#createUnaryOperator()
	 */
	<T> CtUnaryOperator createUnaryOperator();

	/**
	 *  @see CoreFactory#createVariableRead()
	 */
	<T> CtVariableRead createVariableRead();

	/**
	 *  @see CoreFactory#createVariableWrite()
	 */
	<T> CtVariableWrite createVariableWrite();

	/**
	 *  @see CoreFactory#createAnnotationMethod()
	 */
	<T> CtAnnotationMethod createAnnotationMethod();

	/**
	 *  @see CoreFactory#createClass()
	 */
	<T> CtClass createClass();

	/**
	 *  @see CoreFactory#createConstructor()
	 */
	<T> CtConstructor createConstructor();

	/**
	 *  @see CoreFactory#createInvisibleArrayConstructor() ()
	 */
	<T> CtConstructor createInvisibleArrayConstructor();

	/**
	 *  @see CoreFactory#createEnumValue()
	 */
	<T> CtEnumValue createEnumValue();

	/**
	 *  @see CoreFactory#createField()
	 */
	<T> CtField createField();

	/**
	 *  @see CoreFactory#createInterface()
	 */
	<T> CtInterface createInterface();

	/**
	 *  @see CoreFactory#createMethod()
	 */
	<T> CtMethod createMethod();

	/**
	 *  @see CoreFactory#createParameter()
	 */
	<T> CtParameter createParameter();

	/**
	 *  @see CoreFactory#createArrayTypeReference()
	 */
	<T> CtArrayTypeReference createArrayTypeReference();

	/**
	 *  @see CoreFactory#createCatchVariableReference()
	 */
	<T> CtCatchVariableReference createCatchVariableReference();

	/**
	 *  @see CoreFactory#createExecutableReference()
	 */
	<T> CtExecutableReference createExecutableReference();

	/**
	 *  @see CoreFactory#createFieldReference()
	 */
	<T> CtFieldReference createFieldReference();

	/**
	 *  @see CoreFactory#createIntersectionTypeReference()
	 */
	<T> CtIntersectionTypeReference createIntersectionTypeReference();

	/**
	 *  @see CoreFactory#createLocalVariableReference()
	 */
	<T> CtLocalVariableReference createLocalVariableReference();

	/**
	 *  @see CoreFactory#createParameterReference()
	 */
	<T> CtParameterReference createParameterReference();

	/**
	 *  @see CoreFactory#createTypeReference()
	 */
	<T> CtTypeReference createTypeReference();

	/**
	 *  @see CoreFactory#createUnboundVariableReference()
	 */
	<T> CtUnboundVariableReference createUnboundVariableReference();
	 ...
	 */
	<T> CtParameter createParameter(CtExecutable parent, CtTypeReference type, String name);

	/**
	 *  @see ExecutableFactory#createParameterReference(CtParameter)
	 */
	<T> CtParameterReference createParameterReference(CtParameter parameter);
	 ...
	 */
	<T> CtArrayTypeReference createArrayReference(String qualifiedName);

	/**
	 *  @see TypeFactory#createArrayReference(CtType)
	 */
	<T> CtArrayTypeReference createArrayReference(CtType type);

	/**
	 *  @see TypeFactory#createArrayReference(CtTypeReference)
	 */
	<T> CtArrayTypeReference createArrayReference(CtTypeReference reference);

	/**
	 *  @see TypeFactory#createIntersectionTypeReferenceWithBounds(List)
	 */
	<T> CtIntersectionTypeReference createIntersectionTypeReferenceWithBounds(List<CtTypeReference> bounds);
	 ...
	 */
	CtConstructor createConstructor(CtClass target, Set<ModifierKind> modifiers, List<CtParameter> parameters, Set<CtTypeReference> thrownTypes);

	/**
	 *
	 * @see ConstructorFactory#create(CtClass, Set, List, Set, CtBlock)
	 */
	CtConstructor createConstructor(CtClass target, Set<ModifierKind> modifiers, List<CtParameter> parameters, Set<CtTypeReference> thrownTypes, CtBlock body);
	 ...
	 */
	CtMethod createMethod(CtClass target, Set<ModifierKind> modifiers, CtTypeReference returnType, String name, List<CtParameter> parameters, Set<CtTypeReference> thrownTypes, CtBlock body);
	 ...
	 */
	CtMethod createMethod(CtType target, Set<ModifierKind> modifiers, CtTypeReference returnType, String name, List<CtParameter> parameters, Set<CtTypeReference> thrownTypes);
	 ...
	 */
	<T> CtTypeReference createReference(String qualifiedName);

	/**
	 * @see TypeFactory#createSimplyQualifiedReference(String)
	 */
	<T> CtTypeReference createSimplyQualifiedReference(String qualifiedName);
