...
public class FactoryImpl implements Factory, Serializable {
	...
	private final CtModel model = new CtModelImpl(this);
		...
		@Override
		public <T> CtConstructor createDefault(CtClass target) {
			return Constructor().createDefault(target);
		}

		@Override
		public <A extends Annotation> CtAnnotation createAnnotation() {
			return Core().createAnnotation();
		}

		@Override
		public <R> CtBlock createBlock() {
			return Core().createBlock();
		}

		@Override
		public <R> CtReturn createReturn() {
		...
		@Override
		public <S> CtCase createCase() {
			return Core().createCase();
		}

		@Override
		public <S> CtSwitch createSwitch() {
			return Core().createSwitch();
		}

		@Override
		public <T, S> CtSwitchExpression createSwitchExpression() {
			return Core().createSwitchExpression();
		}

		@Override
		public <T extends Enum<?>> CtEnum createEnum() {
			return Core().createEnum();
		}

		@Override
		public <T extends Annotation> CtAnnotationType createAnnotationType() {
			return Core().createAnnotationType();
		}

		@Override
		public <T, A extends T> CtAssignment createAssignment() {
			return Core().createAssignment();
		}

		@Override
		public <T, A extends T> CtOperatorAssignment createOperatorAssignment() {
			return Core().createOperatorAssignment();
		}

		@Override
		public <T, E extends CtExpression> CtExecutableReferenceExpression createExecutableReferenceExpression() {
			return Core().createExecutableReferenceExpression();
		}

		@Override
		public <T> CtAnnotationFieldAccess createAnnotationFieldAccess() {
			return Core().createAnnotationFieldAccess();
		}

		@Override
		public <T> CtArrayRead createArrayRead() {
			return Core().createArrayRead();
		}

		@Override
		public <T> CtArrayWrite createArrayWrite() {
			return Core().createArrayWrite();
		}

		@Override
		public <T> CtAssert createAssert() {
			return Core().createAssert();
		}

		@Override
		public <T> CtBinaryOperator createBinaryOperator() {
			return Core().createBinaryOperator();
		}

		@Override
		public <T> CtCatchVariable createCatchVariable() {
			return Core().createCatchVariable();
		}

		@Override
		public <T> CtCodeSnippetExpression createCodeSnippetExpression() {
			return Core().createCodeSnippetExpression();
		}

		@Override
		public <T> CtConditional createConditional() {
			return Core().createConditional();
		}

		@Override
		public <T> CtConstructorCall createConstructorCall() {
			return Core().createConstructorCall();
		}

		@Override
		public <T> CtFieldRead createFieldRead() {
			return Core().createFieldRead();
		}

		@Override
		public <T> CtFieldWrite createFieldWrite() {
			return Core().createFieldWrite();
		}

		@Override
		public <T> CtInvocation createInvocation() {
			return Core().createInvocation();
		}

		@Override
		public <T> CtLambda createLambda() {
		...
		@Override
		public <T> CtLocalVariable createLocalVariable() {
			return Core().createLocalVariable();
		}

		@Override
		public <T> CtNewArray createNewArray() {
			return Core().createNewArray();
		}

		@Override
		public <T> CtNewClass createNewClass() {
			return Core().createNewClass();
		}

		@Override
		public <T> CtSuperAccess createSuperAccess() {
			return Core().createSuperAccess();
		}

		@Override
		public <T> CtThisAccess createThisAccess() {
			return Core().createThisAccess();
		}

		@Override
		public <T> CtTypeAccess createTypeAccess() {
			return Core().createTypeAccess();
		}

		@Override
		public <T> CtUnaryOperator createUnaryOperator() {
			return Core().createUnaryOperator();
		}

		@Override
		public <T> CtVariableRead createVariableRead() {
			return Core().createVariableRead();
		}

		@Override
		public <T> CtVariableWrite createVariableWrite() {
			return Core().createVariableWrite();
		}

		@Override
		public <T> CtAnnotationMethod createAnnotationMethod() {
			return Core().createAnnotationMethod();
		}

		@Override
		public <T> CtClass createClass() {
			return Core().createClass();
		}

		@Override
		public <T> CtConstructor createConstructor() {
			return Core().createConstructor();
		}

		@Override
		public <T> CtConstructor createInvisibleArrayConstructor() {
			return Core().createInvisibleArrayConstructor();
		}

		@Override
		public <T> CtEnumValue createEnumValue() {
			return Core().createEnumValue();
		}

		@Override
		public <T> CtField createField() {
			return Core().createField();
		}

		@Override
		public <T> CtInterface createInterface() {
			return Core().createInterface();
		}

		@Override
		public <T> CtMethod createMethod() {
			return Core().createMethod();
		}

		@Override
		public <T> CtParameter createParameter() {
			return Core().createParameter();
		}

		@Override
		public <T> CtArrayTypeReference createArrayTypeReference() {
			return Core().createArrayTypeReference();
		}

		@Override
		public <T> CtCatchVariableReference createCatchVariableReference() {
			return Core().createCatchVariableReference();
		}

		@Override
		public <T> CtExecutableReference createExecutableReference() {
			return Core().createExecutableReference();
		}

		@Override
		public <T> CtFieldReference createFieldReference() {
			return Core().createFieldReference();
		}

		@Override
		public <T> CtIntersectionTypeReference createIntersectionTypeReference() {
			return Core().createIntersectionTypeReference();
		}

		@Override
		public <T> CtLocalVariableReference createLocalVariableReference() {
			return Core().createLocalVariableReference();
		}

		@Override
		public <T> CtParameterReference createParameterReference() {
			return Core().createParameterReference();
		}

		@Override
		public <T> CtTypeReference createTypeReference() {
		...
		@Override
		public <T> CtParameter createParameter(CtExecutable parent, CtTypeReference type, String name) {
			return Executable().createParameter(parent, type, name);
		}

		@Override
		public <T> CtParameterReference createParameterReference(CtParameter parameter) {
		...
		@Override
		public CtConstructor createConstructor(CtClass target, Set<ModifierKind> modifiers, List<CtParameter> parameters, Set<CtTypeReference> thrownTypes) {
			return Constructor().create(target, modifiers, parameters, thrownTypes);
		}

		@Override
		public CtConstructor createConstructor(CtClass target, Set<ModifierKind> modifiers, List<CtParameter> parameters, Set<CtTypeReference> thrownTypes, CtBlock body) {
		...
		@Override
		public CtMethod createMethod(CtClass target, Set<ModifierKind> modifiers, CtTypeReference returnType, String name, List<CtParameter> parameters, Set<CtTypeReference> thrownTypes, CtBlock body) {
		...
		@Override
		public CtMethod createMethod(CtType target, Set<ModifierKind> modifiers, CtTypeReference returnType, String name, List<CtParameter> parameters, Set<CtTypeReference> thrownTypes) {
