...
public class TypeFactory extends SubFactory {
	...
	public final CtTypeReference VOID = createReference(Void.class);
	public final CtTypeReference STRING = createReference(String.class);
	public final CtTypeReference BOOLEAN = createReference(Boolean.class);
	public final CtTypeReference BYTE = createReference(Byte.class);
	public final CtTypeReference CHARACTER = createReference(Character.class);
	public final CtTypeReference INTEGER = createReference(Integer.class);
	public final CtTypeReference LONG = createReference(Long.class);
	public final CtTypeReference FLOAT = createReference(Float.class);
	public final CtTypeReference DOUBLE = createReference(Double.class);
	public final CtTypeReference VOID_PRIMITIVE = createReference(void.class);
	public final CtTypeReference BOOLEAN_PRIMITIVE = createReference(boolean.class);
	public final CtTypeReference BYTE_PRIMITIVE = createReference(byte.class);
	public final CtTypeReference CHARACTER_PRIMITIVE = createReference(char.class);
	public final CtTypeReference INTEGER_PRIMITIVE = createReference(int.class);
	public final CtTypeReference LONG_PRIMITIVE = createReference(long.class);
	public final CtTypeReference FLOAT_PRIMITIVE = createReference(float.class);
	public final CtTypeReference DOUBLE_PRIMITIVE = createReference(double.class);
	public final CtTypeReference SHORT = createReference(Short.class);
	public final CtTypeReference SHORT_PRIMITIVE = createReference(short.class);
	public final CtTypeReference DATE = createReference(Date.class);
	public final CtTypeReference OBJECT = createReference(Object.class);
	public final CtTypeReference ITERABLE = createReference(Iterable.class);
	public final CtTypeReference COLLECTION = createReference(Collection.class);
	public final CtTypeReference LIST = createReference(List.class);
	public final CtTypeReference SET = createReference(Set.class);
	public final CtTypeReference MAP = createReference(Map.class);
	 ...
	 */
	public CtTypeReference voidType() {
		return VOID.clone();
	}
	 ...
	 */
	public CtTypeReference voidPrimitiveType() {
	 ...
	 */
	public CtTypeReference stringType() {
		return STRING.clone();
	}
	 ...
	 */
	public CtTypeReference booleanType() {
	 ...
	 */
	public CtTypeReference booleanPrimitiveType() {
	 ...
	 */
	public CtTypeReference byteType() {
		return BYTE.clone();
	}
	 ...
	 */
	public CtTypeReference bytePrimitiveType() {
	 ...
	 */
	public CtTypeReference characterType() {
	 ...
	 */
	public CtTypeReference characterPrimitiveType() {
	 ...
	 */
	public CtTypeReference integerType() {
	 ...
	 */
	public CtTypeReference integerPrimitiveType() {
	 ...
	 */
	public CtTypeReference longType() {
		return LONG.clone();
	}
	 ...
	 */
	public CtTypeReference longPrimitiveType() {
	 ...
	 */
	public CtTypeReference floatType() {
		return FLOAT.clone();
	}
	 ...
	 */
	public CtTypeReference floatPrimitiveType() {
	 ...
	 */
	public CtTypeReference doubleType() {
		return DOUBLE.clone();
	}
	 ...
	 */
	public CtTypeReference doublePrimitiveType() {
	 ...
	 */
	public <T> CtArrayTypeReference createArrayReference(CtType type) {
	 ...
	 */
	public <T> CtArrayTypeReference createArrayReference(CtTypeReference reference) {
		CtArrayTypeReference array = factory.Core().createArrayTypeReference();
	 ...
	 * Creates a reference to an array of given type.
	 */
	public <T> CtArrayTypeReference createArrayReference(String qualifiedName) {
		CtArrayTypeReference array = factory.Core().createArrayTypeReference();
		array.setComponentType(createReference(qualifiedName));
		return array;
	}

	public <T> CtTypeReference createReference(Class<T> type) {
	 ...
	 */
	public <T> CtTypeReference createReference(CtType type) {
		return createReference(type, false);
	}
	 ...
	 */
	public <T> CtTypeReference createReference(CtType type, boolean includingFormalTypeParameter) {
	 ...
	 * Create a reference to a simple type
	 */
	public <T> CtTypeReference createReference(String qualifiedName) {
	...
	public <T> CtType get(final String qualifiedName) {
		...
		if (pack != null) {
			CtType type = pack.getType(qualifiedName.substring(packageIndex + 1));
			if (type != null) {
				return type;
			}
		}
		...
		if (inertTypeIndex > 0) {
			...
			CtType t = factory.Type().get(s);
			if (t == null) {
				return null;
			}
			String className = qualifiedName.substring(inertTypeIndex + 1);
			if (t.isLocalType()) {
				final List<CtClass> enclosingClasses = t.getElements(new TypeFilter<CtClass>(spoon.reflect.declaration.CtClass.class) {
					@Override
			...
			if (isNumber(className)) {
				...
				return getFromCache(t, className, k -> {
					...
					final List<CtNewClass> anonymousClasses = t.getElements(new TypeFilter<CtNewClass>(spoon.reflect.code.CtNewClass.class) {
						@Override
	...
	public GenericTypeAdapter createTypeAdapter(CtFormalTypeDeclarer formalTypeDeclarer) {
		class Visitor extends CtAbstractVisitor {
			...
			@Override
			public <T> void visitCtConstructor(CtConstructor c) {
	 ...
	 */
	public <T> CtIntersectionTypeReference createIntersectionTypeReferenceWithBounds(List<CtTypeReference> bounds) {
		final CtIntersectionTypeReference intersectionRef = factory.Core().createIntersectionTypeReference();
