...
class ModelRoleHandlers {
	...
	static class CtExecutable_THROWN_RoleHandler extends SetHandler<CtExecutable, CtTypeReference> {
	...
	static class CtCatch_PARAMETER_RoleHandler extends SingleHandler<CtCatch, CtCatchVariable> {
	...
	static class CtWhile_EXPRESSION_RoleHandler extends SingleHandler<CtWhile, CtExpression> {
	...
	static class CtThrow_EXPRESSION_RoleHandler extends SingleHandler<CtThrow, CtExpression> {
	...
	static class CtFor_EXPRESSION_RoleHandler extends SingleHandler<CtFor, CtExpression> {
	...
	static class CtDo_EXPRESSION_RoleHandler extends SingleHandler<CtDo, CtExpression> {
	...
	static class CtArrayAccess_EXPRESSION_RoleHandler extends SingleHandler<CtArrayAccess, CtExpression> {
	...
	static class CtNewArray_DIMENSION_RoleHandler extends ListHandler<CtNewArray, CtExpression> {
	...
	static class CtIf_CONDITION_RoleHandler extends SingleHandler<CtIf, CtExpression> {
	...
	static class CtConditional_CONDITION_RoleHandler extends SingleHandler<CtConditional, CtExpression> {
	...
	static class CtAssert_CONDITION_RoleHandler extends SingleHandler<CtAssert, CtExpression> {
	...
	static class CtAnnotation_ANNOTATION_TYPE_RoleHandler extends SingleHandler<CtAnnotation, CtTypeReference> {
	...
	static class CtElement_ANNOTATION_RoleHandler extends ListHandler<CtElement, CtAnnotation> {
