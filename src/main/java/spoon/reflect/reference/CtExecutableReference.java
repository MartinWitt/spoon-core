 ...
 */
public interface CtExecutableReference extends CtReference, CtActualTypeContainer {
	...
	<C extends CtExecutableReference> C setParameters(List<CtTypeReference> parameters);
	 ...
	 */
	<S > CtExecutableReference getOverridingExecutable(CtTypeReference subType);
	...
	<C extends CtExecutableReference> C setDeclaringType(CtTypeReference declaringType);

	/**
	 * Sets this executable reference to be static or not.
	 */
	@PropertySetter(role = CtRole.IS_STATIC)
	<C extends CtExecutableReference> C setStatic(boolean b);

	/**
	 * Sets the type of the variable.
	 */
	@PropertySetter(role = CtRole.TYPE)
	<C extends CtExecutableReference> C setType(CtTypeReference type);
