 ...
 */
public interface CtTypeReference extends CtReference, CtActualTypeContainer, CtTypeInformation, CtShadowable {
	...
	<C extends CtTypeReference> C setDeclaringType(CtTypeReference type);

	/**
	 * Sets the reference to the declaring package.
	 */
	@PropertySetter(role = PACKAGE_REF)
	<C extends CtTypeReference> C setPackage(CtPackageReference pack);

	/**
	 * Casts the type reference in {@link CtIntersectionTypeReference}.
	 */
	CtIntersectionTypeReference asCtIntersectionTypeReference();
