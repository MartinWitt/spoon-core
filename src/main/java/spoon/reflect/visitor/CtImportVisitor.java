...
public interface CtImportVisitor {
	 ...
	 */
	<T> void visitTypeImport(CtTypeReference typeReference);
	/**
	 * Called for import like:
	 * <code>import apackage.Type.staticMethod;</code>
	 */
	<T> void visitMethodImport(CtExecutableReference executableReference);
	/**
	 * Called for import like:
	 * <code>import apackage.Type.staticField;</code>
	 */
	<T> void visitFieldImport(CtFieldReference fieldReference);
	/**
	 * Called for import like:
