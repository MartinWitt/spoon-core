...
public abstract class CtInheritanceScanner implements CtVisitor {
	 ...
	 */
	public <T> void scanCtAbstractInvocation(CtAbstractInvocation a) {
	}

	/**
	 * Scans an abstract switch (either switch statement or switch expression).
	 */
	public <S> void scanCtAbstractSwitch(CtAbstractSwitch a) {
	}
	 ...
	 */
	public <T> void scanCtExpression(CtExpression expression) {
	}
	 ...
	 */
	public <T> void scanCtTypedElement(CtTypedElement e) {
	}
	 ...
	 */
	public <T, E extends CtExpression> void scanCtArrayAccess(CtArrayAccess arrayAccess) {
	}

	/**
	 * Scans a field access (read and write).
	 */
	public <T> void scanCtFieldAccess(CtFieldAccess fieldAccess) {
	}

	/**
	 * Scans a variable access (read and write).
	 */
	public <T> void scanCtVariableAccess(CtVariableAccess variableAccess) {
	}

	/**
	 * Scans the right-hand side of an assignment
	 */
	public <T> void scanCtRHSReceiver(CtRHSReceiver ctRHSReceiver) {
	}
	...
	*/
	 ...
	 */
	public <T> void scanCtVariableReference(CtVariableReference reference) {
	}
	...
	public <A extends Annotation> void visitCtAnnotationType(CtAnnotationType e) {
		scanCtType(e);
	...
	public <T> void visitCtArrayTypeReference(CtArrayTypeReference e) {
		visitCtTypeReference(e);
	}

	public <T> void visitCtAssert(CtAssert e) {
		scanCtStatement(e);
		scanCtCodeElement(e);
		scanCtElement(e);
		scanCtVisitable(e);
	...
	public <T> void visitCtBinaryOperator(CtBinaryOperator e) {
		scanCtExpression(e);
		scanCtCodeElement(e);
		scanCtTypedElement(e);
		scanCtElement(e);
	...
	public <R> void visitCtBlock(CtBlock e) {
		scanCtStatement(e);
	...
	public <E> void visitCtCase(CtCase e) {
		scanCtStatement(e);
		visitCtStatementList(e);
	}
	...
	public <T> void visitCtClass(CtClass e) {
		scanCtType(e);
		scanCtSealable(e);
		scanCtStatement(e);
		scanCtTypeInformation(e);
	...
	public <T> void visitCtConditional(CtConditional e) {
		scanCtExpression(e);
		scanCtCodeElement(e);
		scanCtTypedElement(e);
		scanCtElement(e);
	...
	public <T extends Enum<?>> void visitCtEnum(CtEnum e) {
		visitCtClass(e);
	}

	public <T> void visitCtExecutableReference(CtExecutableReference e) {
		scanCtReference(e);
		scanCtElement(e);
	...
	public <T> void visitCtField(CtField e) {
		scanCtNamedElement(e);
		scanCtVariable(e);
		scanCtTypeMember(e);
		scanCtModifiable(e);
	...
	public <T> void visitCtThisAccess(CtThisAccess e) {
	...
	public <T> void visitCtFieldReference(CtFieldReference e) {
	...
	public <T> void visitCtInterface(CtInterface e) {
		scanCtType(e);
		scanCtSealable(e);
		scanCtStatement(e);
		scanCtTypeInformation(e);
	...
	public <T> void visitCtInvocation(CtInvocation e) {
	...
	public <T> void visitCtLocalVariable(CtLocalVariable e) {
		scanCtStatement(e);
		scanCtVariable(e);
		scanCtCodeElement(e);
		scanCtNamedElement(e);
	...
	public <T> void visitCtCatchVariableReference(CtCatchVariableReference e) {
		scanCtVariableReference(e);
		scanCtReference(e);
		scanCtElement(e);
		scanCtVisitable(e);
	...
	public <T> void visitCtNewArray(CtNewArray e) {
		scanCtExpression(e);
		scanCtCodeElement(e);
		scanCtTypedElement(e);
		scanCtElement(e);
	...
	@Override
	public <T> void visitCtConstructorCall(CtConstructorCall e) {
		scanCtTargetedExpression(e);
		scanCtAbstractInvocation(e);
		scanCtStatement(e);
		scanCtActualTypeContainer(e);
	...
	public <T> void visitCtNewClass(CtNewClass e) {
		visitCtConstructorCall(e);
	}

	@Override
	public <T> void visitCtLambda(CtLambda e) {
		scanCtExpression(e);
		scanCtCodeElement(e);
		scanCtTypedElement(e);
		scanCtExecutable(e);
	...
	@Override
	public <T, E extends CtExpression> void visitCtExecutableReferenceExpression(CtExecutableReferenceExpression e) {
		scanCtTargetedExpression(e);
		scanCtExpression(e);
		scanCtCodeElement(e);
		scanCtTypedElement(e);
	...
	public <T> void visitCtParameter(CtParameter e) {
		scanCtNamedElement(e);
		scanCtVariable(e);
		scanCtModifiable(e);
		scanCtTypedElement(e);
	...
	public <T> void visitCtParameterReference(CtParameterReference e) {
		scanCtVariableReference(e);
		scanCtReference(e);
		scanCtElement(e);
		scanCtVisitable(e);
	...
	public <R> void visitCtReturn(CtReturn e) {
		scanCtCFlowBreak(e);
		scanCtStatement(e);
		scanCtCodeElement(e);
		scanCtElement(e);
	...
	public <E> void visitCtSwitch(CtSwitch e) {
	...
	public <T, S> void visitCtSwitchExpression(CtSwitchExpression e) {
		scanCtAbstractSwitch(e);
		scanCtExpression(e);
		scanCtCodeElement(e);
		scanCtTypedElement(e);
	...
	@Override
	public <T> void visitCtIntersectionTypeReference(CtIntersectionTypeReference e) {
		visitCtTypeReference(e);
	}

	public <T> void visitCtTypeReference(CtTypeReference e) {
		scanCtReference(e);
		scanCtTypeInformation(e);
		scanCtActualTypeContainer(e);
		scanCtElement(e);
	...
	@Override
	public <T> void visitCtTypeAccess(CtTypeAccess e) {
		scanCtExpression(e);
		scanCtCodeElement(e);
		scanCtTypedElement(e);
		scanCtElement(e);
	...
	public <T> void visitCtUnaryOperator(CtUnaryOperator e) {
		scanCtExpression(e);
		scanCtStatement(e);
		scanCtCodeElement(e);
		scanCtTypedElement(e);
	...
	@Override
	public <T> void visitCtVariableRead(CtVariableRead e) {
	...
	@Override
	public <T> void visitCtVariableWrite(CtVariableWrite e) {
		scanCtVariableAccess(e);
		scanCtExpression(e);
		scanCtCodeElement(e);
		scanCtTypedElement(e);
