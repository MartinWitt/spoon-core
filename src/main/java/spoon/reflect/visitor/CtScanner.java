...
public abstract class CtScanner implements CtVisitor {
	...
	public <A extends Annotation> void visitCtAnnotation(final CtAnnotation annotation) {
		enter(annotation);
	...
	public <A extends Annotation> void visitCtAnnotationType(final CtAnnotationType annotationType) {
	...
	@Override
	public <T> void visitCtArrayRead(final CtArrayRead arrayRead) {
		enter(arrayRead);
	...
	@Override
	public <T> void visitCtArrayWrite(final CtArrayWrite arrayWrite) {
		enter(arrayWrite);
	...
	public <T> void visitCtArrayTypeReference(final CtArrayTypeReference reference) {
		enter(reference);
	...
	public <T> void visitCtAssert(final CtAssert asserted) {
		enter(asserted);
	...
	public <T, A extends T> void visitCtAssignment(final CtAssignment assignement) {
		enter(assignement);
	...
	public <T> void visitCtBinaryOperator(final CtBinaryOperator operator) {
		enter(operator);
	...
	public <R> void visitCtBlock(final CtBlock block) {
		enter(block);
	...
	public <S> void visitCtCase(final CtCase caseStatement) {
		enter(caseStatement);
	...
	public <T> void visitCtClass(final CtClass ctClass) {
		enter(ctClass);
	...
	public <T> void visitCtConditional(final CtConditional conditional) {
		enter(conditional);
	...
	public <T> void visitCtConstructor(final CtConstructor c) {
		enter(c);
	...
	public <T extends Enum<?>> void visitCtEnum(final CtEnum ctEnum) {
		enter(ctEnum);
	...
	public <T> void visitCtExecutableReference(final CtExecutableReference reference) {
		enter(reference);
		scan(CtRole.DECLARING_TYPE, reference.getDeclaringType());
	...
	public <T> void visitCtField(final CtField f) {
		enter(f);
	...
	@Override
	public <T> void visitCtEnumValue(final CtEnumValue enumValue) {
		enter(enumValue);
	...
	@Override
	public <T> void visitCtThisAccess(final CtThisAccess thisAccess) {
		enter(thisAccess);
	...
	public <T> void visitCtAnnotationFieldAccess(final CtAnnotationFieldAccess annotationFieldAccess) {
	...
	public <T> void visitCtFieldReference(final CtFieldReference reference) {
		enter(reference);
		scan(CtRole.DECLARING_TYPE, reference.getDeclaringType());
		scan(CtRole.TYPE, reference.getType());
		scan(CtRole.ANNOTATION, reference.getAnnotations());
	...
	public <T> void visitCtInterface(final CtInterface intrface) {
		enter(intrface);
	...
	public <T> void visitCtInvocation(final CtInvocation invocation) {
		enter(invocation);
	...
	public <T> void visitCtLocalVariable(final CtLocalVariable localVariable) {
		enter(localVariable);
	...
	public <T> void visitCtLocalVariableReference(final CtLocalVariableReference reference) {
		enter(reference);
		scan(CtRole.TYPE, reference.getType());
		scan(CtRole.ANNOTATION, reference.getAnnotations());
		exit(reference);
	...
	public <T> void visitCtCatchVariable(final CtCatchVariable catchVariable) {
		enter(catchVariable);
	...
	public <T> void visitCtCatchVariableReference(final CtCatchVariableReference reference) {
		enter(reference);
		scan(CtRole.TYPE, reference.getType());
		scan(CtRole.ANNOTATION, reference.getAnnotations());
		exit(reference);
	...
	public <T> void visitCtMethod(final CtMethod m) {
		enter(m);
	...
	public <T> void visitCtNewArray(final CtNewArray newArray) {
		enter(newArray);
	...
	@Override
	public <T> void visitCtConstructorCall(final CtConstructorCall ctConstructorCall) {
	...
	public <T> void visitCtNewClass(final CtNewClass newClass) {
		enter(newClass);
	...
	@Override
	public <T> void visitCtLambda(final CtLambda lambda) {
		enter(lambda);
	...
	@Override
	public <T, E extends CtExpression> void visitCtExecutableReferenceExpression(final CtExecutableReferenceExpression expression) {
		enter(expression);
	...
	public <T, A extends T> void visitCtOperatorAssignment(final CtOperatorAssignment assignment) {
		enter(assignment);
	...
	public <T> void visitCtParameter(final CtParameter parameter) {
		enter(parameter);
	...
	public <T> void visitCtParameterReference(final CtParameterReference reference) {
		enter(reference);
		scan(CtRole.TYPE, reference.getType());
		scan(CtRole.ANNOTATION, reference.getAnnotations());
		exit(reference);
	...
	public <R> void visitCtReturn(final CtReturn returnStatement) {
	...
	public <S> void visitCtSwitch(final CtSwitch switchStatement) {
	...
	public <T, S> void visitCtSwitchExpression(final CtSwitchExpression switchExpression) {
	...
	@Override
	public <T> void visitCtIntersectionTypeReference(final CtIntersectionTypeReference reference) {
		enter(reference);
		scan(CtRole.PACKAGE_REF, reference.getPackage());
		scan(CtRole.DECLARING_TYPE, reference.getDeclaringType());
	...
	public <T> void visitCtTypeReference(final CtTypeReference reference) {
		enter(reference);
		scan(CtRole.PACKAGE_REF, reference.getPackage());
		scan(CtRole.DECLARING_TYPE, reference.getDeclaringType());
		scan(CtRole.TYPE_ARGUMENT, reference.getActualTypeArguments());
	...
	@Override
	public <T> void visitCtTypeAccess(final CtTypeAccess typeAccess) {
		enter(typeAccess);
	...
	public <T> void visitCtUnaryOperator(final CtUnaryOperator operator) {
		enter(operator);
		scan(CtRole.ANNOTATION, operator.getAnnotations());
		scan(CtRole.TYPE, operator.getType());
		scan(CtRole.CAST, operator.getTypeCasts());
	...
	@Override
	public <T> void visitCtVariableRead(final CtVariableRead variableRead) {
		enter(variableRead);
	...
	@Override
	public <T> void visitCtVariableWrite(final CtVariableWrite variableWrite) {
		enter(variableWrite);
	...
	public <T> void visitCtCodeSnippetExpression(final CtCodeSnippetExpression expression) {
		enter(expression);
		scan(CtRole.TYPE, expression.getType());
		scan(CtRole.COMMENT, expression.getComments());
		scan(CtRole.ANNOTATION, expression.getAnnotations());
	...
	public <T> void visitCtUnboundVariableReference(final CtUnboundVariableReference reference) {
		enter(reference);
		scan(CtRole.TYPE, reference.getType());
		exit(reference);
	}
	...
	@Override
	public <T> void visitCtFieldRead(final CtFieldRead fieldRead) {
		enter(fieldRead);
	...
	@Override
	public <T> void visitCtFieldWrite(final CtFieldWrite fieldWrite) {
		enter(fieldWrite);
	...
	@Override
	public <T> void visitCtSuperAccess(final CtSuperAccess f) {
		enter(f);
		scan(CtRole.COMMENT, f.getComments());
		scan(CtRole.ANNOTATION, f.getAnnotations());
