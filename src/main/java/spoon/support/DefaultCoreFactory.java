...
public class DefaultCoreFactory extends SubFactory implements CoreFactory {
	...
	public <T> CtArrayRead createArrayRead() {
		CtArrayRead e = new CtArrayReadImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtArrayWrite createArrayWrite() {
		CtArrayWrite e = new CtArrayWriteImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtConstructor createInvisibleArrayConstructor() {
		CtConstructor e = new InvisibleArrayConstructorImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtEnumValue createEnumValue() {
		CtEnumValue e = new CtEnumValueImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtFieldRead createFieldRead() {
		CtFieldRead e = new CtFieldReadImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtFieldWrite createFieldWrite() {
		CtFieldWrite e = new CtFieldWriteImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtAnnotationFieldAccess createAnnotationFieldAccess() {
		CtAnnotationFieldAccess e = new CtAnnotationFieldAccessImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtUnboundVariableReference createUnboundVariableReference() {
		CtUnboundVariableReference e = new CtUnboundVariableReferenceImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtCatchVariable createCatchVariable() {
		CtCatchVariable e = new CtCatchVariableImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtCatchVariableReference createCatchVariableReference() {
		CtCatchVariableReference e = new CtCatchVariableReferenceImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtAnnotationMethod createAnnotationMethod() {
		CtAnnotationMethod e = new CtAnnotationMethodImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtConstructorCall createConstructorCall() {
		CtConstructorCall e = new CtConstructorCallImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T, E extends CtExpression> CtExecutableReferenceExpression createExecutableReferenceExpression() {
		CtExecutableReferenceExpression e = new CtExecutableReferenceExpressionImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtIntersectionTypeReference createIntersectionTypeReference() {
		CtIntersectionTypeReference e = new CtIntersectionTypeReferenceImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtTypeAccess createTypeAccess() {
		CtTypeAccess e = new CtTypeAccessImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtVariableRead createVariableRead() {
		CtVariableRead e = new CtVariableReadImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public <T> CtVariableWrite createVariableWrite() {
		CtVariableWrite e = new CtVariableWriteImpl();
		e.setFactory(getMainFactory());
		return e;
	}
	...
	public BodyHolderSourcePosition createBodyHolderSourcePosition(CompilationUnit compilationUnit, int nameStart, int nameEnd, int modifierStart, int modifierEnd, int declarationStart, int declarationEnd, int bodyStart, int bodyEnd, int[] lineSeparatorPositions) {
		return new BodyHolderSourcePositionImpl(compilationUnit, nameStart, nameEnd, modifierStart, modifierEnd, declarationStart, declarationEnd, bodyStart, bodyEnd, lineSeparatorPositions);
	}
