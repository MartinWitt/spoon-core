...
public class SnippetCompilationHelper {
	...
	public static <T> CtExpression compileExpression(
			CtCodeSnippetExpression expr) throws SnippetCompilationError {

		CtReturn ret = ((CtReturn) (internalCompileStatement(expr, expr.getFactory().Type().OBJECT)));
