		...
		if (child instanceof CtExpression) {
			if (operator.getLeftHandOperand() == null) {
				...
				if (operator.getRightHandOperand() == null) {
					...
					if (jdtTreeBuilder.getContextBuilder().getCurrentNode() instanceof StringLiteralConcatenation) {
		...
		if (childJDT instanceof TypeReference && child instanceof CtTypeAccess) {
			...
			if (child instanceof CtExpression) {
				if (isContainedInDimensionExpression()) {
					...
					if (child instanceof CtNewArray && childJDT instanceof ArrayInitializer && jdtTreeBuilder.getContextBuilder().getCurrentNode() instanceof ArrayAllocationExpression) {
