...
public class CtAssignmentImpl extends CtStatementImpl implements CtAssignment {
	...
	@Override
	public <C extends CtAssignment> C setAssigned(CtExpression assigned) {
		if (assigned != null) {
	...
	@Override
	public <C extends CtExpression> C addTypeCast(CtTypeReference type) {
		if (type == null) {
			return ((C) (this));
		}
	...
	@Override
	public CtAssignment clone() {
		return ((CtAssignment) (super.clone()));
	}
}
