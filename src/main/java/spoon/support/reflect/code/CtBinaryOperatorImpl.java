...
public class CtBinaryOperatorImpl extends CtExpressionImpl implements CtBinaryOperator {
	...
	@Override
	public <C extends CtBinaryOperator> C setLeftHandOperand(CtExpression expression) {
		if (expression != null) {
	...
	@Override
	public <C extends CtBinaryOperator> C setRightHandOperand(CtExpression expression) {
		if (expression != null) {
			expression.setParent(this);
		}
	...
	@Override
	public <C extends CtBinaryOperator> C setKind(BinaryOperatorKind kind) {
	...
	@Override
	public CtBinaryOperator clone() {
		return ((CtBinaryOperator) (super.clone()));
	}
}
