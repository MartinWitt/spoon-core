...
public class CtCaseImpl extends CtStatementImpl implements CtCase {
	private static final long serialVersionUID = 1L;

	@MetamodelPropertyField(role = CtRole.EXPRESSION)
	List<CtExpression> caseExpressions = emptyList();
	...
	@Override
	public <T extends CtCase> T setCaseExpression(CtExpression caseExpression) {
	...
	@Override
	public List<CtExpression> getCaseExpressions() {
		return caseExpressions;
	}

	@Override
	public <T extends CtCase> T setCaseExpressions(List<CtExpression> caseExpressions) {
	...
	@Override
	public <T extends CtCase> T addCaseExpression(CtExpression caseExpression) {
		if (caseExpression == null) {
			return ((T) (this));
		}
	...
	@Override
	public <T extends CtCase> T setCaseKind(CaseKind kind) {
	...
	private void ensureModifiableCaseExpressionsList() {
		if (this.caseExpressions == CtElementImpl.<CtExpression>emptyList()) {
