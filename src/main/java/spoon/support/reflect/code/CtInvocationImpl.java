...
public class CtInvocationImpl extends CtTargetedExpressionImpl implements CtInvocation {
	...
	private <C extends CtAbstractInvocation> C addArgument(int position, CtExpression argument) {
		if (argument == null) {
			return ((C) ( this));
		}
	...
	@Override
	public <C extends CtAbstractInvocation> C addArgument(CtExpression argument) {
		return addArgument(arguments.size(), argument);
	}

	@Override
	public <C extends CtAbstractInvocation> C addArgumentAt(int position, CtExpression argument) {
	...
	@Override
	public <C extends CtAbstractInvocation> C setArguments(List<CtExpression> arguments) {
	...
	@Override
	public <C extends CtAbstractInvocation> C setExecutable(CtExecutableReference executable) {
		if (executable != null) {
			executable.setParent(this);
		}
	...
	@Override
	public CtInvocation clone() {
		return ((CtInvocation) (super.clone()));
	}
}
