...
public class CtNewArrayImpl extends CtExpressionImpl implements CtNewArray {
	private static final long serialVersionUID = 1L;

	@MetamodelPropertyField(role = DIMENSION)
	List<CtExpression> dimensionExpressions = emptyList();
	...
	@Override
	public List<CtExpression> getDimensionExpressions() {
	...
	@Override
	public <C extends CtNewArray> C setDimensionExpressions(List<CtExpression> dimensionExpressions) {
	...
	@Override
	public <C extends CtNewArray> C addDimensionExpression(CtExpression dimension) {
		if (dimension == null) {
			return ((C) (this));
		}
		if (dimensionExpressions == CtElementImpl.<CtExpression>emptyList()) {
	...
	@Override
	public boolean removeDimensionExpression(CtExpression dimension) {
		if (dimensionExpressions == CtElementImpl.<CtExpression>emptyList()) {
			return false;
		}
	...
	@Override
	public <C extends CtNewArray> C setElements(List<CtExpression> expressions) {
	...
	@Override
	public <C extends CtNewArray> C addElement(CtExpression expression) {
		if (expression == null) {
			return ((C) (this));
		}
