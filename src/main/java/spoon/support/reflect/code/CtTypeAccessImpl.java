...
public class CtTypeAccessImpl extends CtExpressionImpl implements CtTypeAccess {
	...
	@Override
	public CtTypeReference getAccessedType() {
		return type;
	}

	@Override
	public <C extends CtTypeAccess> C setAccessedType(CtTypeReference accessedType) {
	...
	public CtTypeReference getType() {
		return ((CtTypeReference) (getFactory().Type().VOID_PRIMITIVE.clone().<CtTypeAccess>setParent(this)));
	}
	...
	@Override
	public CtTypeAccess clone() {
		return ((CtTypeAccess) (super.clone()));
	}
}
