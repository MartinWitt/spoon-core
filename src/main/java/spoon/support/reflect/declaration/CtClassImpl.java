 ...
 */
public class CtClassImpl extends CtTypeImpl implements CtClass {
	...
	public Set<CtConstructor> getConstructors() {
		Set<CtConstructor> constructors = new SignatureBasedSortedSet<>();
		for (CtTypeMember typeMember : typeMembers) {
			if (typeMember instanceof CtConstructor) {
	...
	@Override
	public <C extends CtClass> C addAnonymousExecutable(CtAnonymousExecutable e) {
		if (e == null) {
			return ((C) (this));
		}
		e.setParent(this);
	...
	@Override
	public <C extends CtClass> C setAnonymousExecutables(List<CtAnonymousExecutable> anonymousExecutables) {
	...
	@Override
	public <C extends CtClass> C setConstructors(Set<CtConstructor> constructors) {
		Set<CtConstructor> oldConstructor = getConstructors();
	...
	@Override
	public <C extends CtClass> C addConstructor(CtConstructor constructor) {
	...
	@Override
	public void removeConstructor(CtConstructor constructor) {
	...
	@Override
	public CtClass setPermittedTypes(Collection<CtTypeReference> permittedTypes) {
	...
	@Override
	public CtClass addPermittedType(CtTypeReference type) {
		if (type == null) {
			return this;
		}
	...
	@Override
	public CtClass removePermittedType(CtTypeReference type) {
		if (this.permittedTypes == CtElementImpl.<CtTypeReference>emptySet()) {
			return this;
		}
