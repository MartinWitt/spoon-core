...
public class CtEnumImpl extends CtClassImpl implements CtEnum {
	...
	@Override
	public <C extends CtEnum> C addEnumValue(CtEnumValue enumValue) {
		if (enumValue == null) {
			return ((C) (this));
		}
	...
	@Override
	public <C extends CtEnum> C setEnumValues(List<CtEnumValue> enumValues) {
		if (enumValues == null) {
	...
	@Override
	@UnsettableProperty
	public CtEnum setPermittedTypes(Collection<CtTypeReference> permittedTypes) {
		return this;
	}

	@Override
	@UnsettableProperty
	public CtEnum addPermittedType(CtTypeReference type) {
		return this;
	}

	@Override
	@UnsettableProperty
	public CtEnum removePermittedType(CtTypeReference type) {
		return this;
	}
