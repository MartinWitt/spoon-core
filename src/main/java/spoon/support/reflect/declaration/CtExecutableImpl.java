 ...
 */
public abstract class CtExecutableImpl extends CtNamedElementImpl implements CtExecutable {
	...
	@Override
	public <T extends CtExecutable> T setParameters(List<CtParameter> parameters) {
	...
	@Override
	public <T extends CtExecutable> T addParameter(CtParameter parameter) {
		addParameterAt(parameters.size(), parameter);
		return ((T) (this));
	}

	@Override
	public <T extends CtExecutable> T addParameterAt(int position, CtParameter parameter) {
		if (parameter == null) {
			return ((T) (this));
		}
	...
	@Override
	public <T extends CtExecutable> T setThrownTypes(Set<CtTypeReference> thrownTypes) {
		if (thrownTypes == null || thrownTypes.isEmpty()) {
			this.thrownTypes = CtElementImpl.emptySet();
			return ((T) (this));
		}
		if (this.thrownTypes == CtElementImpl.<CtTypeReference>emptySet()) {
	...
	@Override
	public <T extends CtExecutable> T addThrownType(CtTypeReference throwType) {
		if (throwType == null) {
			return ((T) (this));
		}
