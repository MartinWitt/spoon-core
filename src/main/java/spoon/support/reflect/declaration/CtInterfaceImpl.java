...
public class CtInterfaceImpl extends CtTypeImpl implements CtInterface {
	...
	@Override
	public CtInterface setPermittedTypes(Collection<CtTypeReference> permittedTypes) {
	...
	@Override
	public CtInterface addPermittedType(CtTypeReference type) {
		if (type == null) {
			return this;
		}
	...
	@Override
	public CtInterface removePermittedType(CtTypeReference type) {
		if (this.permittedTypes == CtElementImpl.<CtTypeReference>emptySet()) {
			return this;
		}
	...
	public <N> boolean removeNestedType(CtType nestedType) {
		...
		newModifiers.removeIf(modifier -> modifier.isImplicit() && addedKinds.contains(modifier.getKind()));
