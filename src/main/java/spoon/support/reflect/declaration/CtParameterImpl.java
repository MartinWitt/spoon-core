 ...
 */
public class CtParameterImpl extends CtNamedElementImpl implements CtParameter {
	...
	@Override
	public <U extends CtParameter> U setInferred(boolean inferred) {
	...
	@Override
	public <C extends CtParameter> C setVarArgs(boolean varArgs) {
	...
	@Override
	public CtParameter clone() {
		return ((CtParameter) (super.clone()));
	}
