...
public abstract class CtTypeImpl extends CtNamedElementImpl implements CtType {
	...
	public <N extends CtType> N getNestedType(final String name) {
		class NestedTypeScanner extends EarlyTerminatingScanner<CtType> {
			...
			@Override
			public <U> void visitCtClass(spoon.reflect.declaration.CtClass ctClass) {
			...
			@Override
			public <U> void visitCtInterface(spoon.reflect.declaration.CtInterface intrface) {
			...
			@Override
			public <U extends java.lang.Enum<?>> void visitCtEnum(spoon.reflect.declaration.CtEnum ctEnum) {
				if (!checkType(ctEnum)) {
					final List<CtTypeMember> typeMembers = new ArrayList<>();
