...
public class CtFieldReferenceImpl extends CtVariableReferenceImpl implements CtFieldReference {
	...
	private CtField fromDeclaringType() {
		if (declaringType == null) {
			return null;
		}
		CtType type = declaringType.getDeclaration();
		if (type != null) {
			return ((CtField) (type.getField(getSimpleName())));
		}
		return null;
	}

	@Override
	public CtField getFieldDeclaration() {
		if (declaringType == null) {
			return null;
		}
		CtType type = declaringType.getTypeDeclaration();
		if (type != null) {
			final CtField ctField = ((CtField) (type.getField(getSimpleName())));
	...
	@Override
	public <C extends CtFieldReference> C setDeclaringType(CtTypeReference declaringType) {
		if (declaringType != null) {
	...
	@Override
	public <C extends CtFieldReference> C setFinal(boolean fina) {
	...
	@Override
	public <C extends CtFieldReference> C setStatic(boolean stat) {
