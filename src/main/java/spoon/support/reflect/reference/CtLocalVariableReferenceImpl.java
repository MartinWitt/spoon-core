 ...
 */
public class CtLocalVariableReferenceImpl
		extends CtVariableReferenceImpl implements CtLocalVariableReference {
	...
	@Override
	public CtLocalVariableReference clone() {
		return ((CtLocalVariableReference) (super.clone()));
	}
}
