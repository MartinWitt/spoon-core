...
public class CtParameterReferenceImpl extends CtVariableReferenceImpl implements CtParameterReference {
	...
	public CtExecutableReference getDeclaringExecutable() {
		CtParameter declaration = getDeclaration();
		if (declaration == null) {
			return null;
		}
	...
	public CtParameter getDeclaration() {
		final CtParameter ctParameter = lookupDynamically();
		if (ctParameter != null) {
			return ctParameter;
		}
		return null;
	...
	@Override
	public CtParameterReference clone() {
		return ((CtParameterReference) (super.clone()));
	}
}
