...
public abstract class Parameters {
	 ...
	 */
	public static List<String> getNames(CtClass templateType) {
	 ...
	 * (including the ones defined by the super types).
	 */
	public static Map<String, Object> getNamesToValues(Template<?> template, CtClass templateType) {
	...
	private static synchronized CtTypeReference getTemplateParameterType(Factory factory) {
		if (templateParameterType == null) {
			templateParameterType = ((CtTypeReference) (factory.Type().createReference(spoon.template.TemplateParameter.class)));
		}
