...
public class CloneVisitor extends spoon.reflect.visitor.CtScanner {
	...
	public <A extends java.lang.annotation.Annotation> void visitCtAnnotation(final spoon.reflect.declaration.CtAnnotation annotation) {
		spoon.reflect.declaration.CtAnnotation aCtAnnotation = annotation.getFactory().Core().createAnnotation();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <A extends java.lang.annotation.Annotation> void visitCtAnnotationType(final spoon.reflect.declaration.CtAnnotationType annotationType) {
		spoon.reflect.declaration.CtAnnotationType aCtAnnotationType = annotationType.getFactory().Core().createAnnotationType();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtArrayRead(final spoon.reflect.code.CtArrayRead arrayRead) {
		spoon.reflect.code.CtArrayRead aCtArrayRead = arrayRead.getFactory().Core().createArrayRead();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtArrayWrite(final spoon.reflect.code.CtArrayWrite arrayWrite) {
		spoon.reflect.code.CtArrayWrite aCtArrayWrite = arrayWrite.getFactory().Core().createArrayWrite();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtArrayTypeReference(final spoon.reflect.reference.CtArrayTypeReference reference) {
		spoon.reflect.reference.CtArrayTypeReference aCtArrayTypeReference = reference.getFactory().Core().createArrayTypeReference();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtAssert(final spoon.reflect.code.CtAssert asserted) {
		spoon.reflect.code.CtAssert aCtAssert = asserted.getFactory().Core().createAssert();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T, A extends T> void visitCtAssignment(final spoon.reflect.code.CtAssignment assignement) {
		spoon.reflect.code.CtAssignment aCtAssignment = assignement.getFactory().Core().createAssignment();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtBinaryOperator(final spoon.reflect.code.CtBinaryOperator operator) {
		spoon.reflect.code.CtBinaryOperator aCtBinaryOperator = operator.getFactory().Core().createBinaryOperator();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <R> void visitCtBlock(final spoon.reflect.code.CtBlock block) {
		spoon.reflect.code.CtBlock aCtBlock = block.getFactory().Core().createBlock();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <S> void visitCtCase(final spoon.reflect.code.CtCase caseStatement) {
		spoon.reflect.code.CtCase aCtCase = caseStatement.getFactory().Core().createCase();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtClass(final spoon.reflect.declaration.CtClass ctClass) {
		spoon.reflect.declaration.CtClass aCtClass = ctClass.getFactory().Core().createClass();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtConditional(final spoon.reflect.code.CtConditional conditional) {
		spoon.reflect.code.CtConditional aCtConditional = conditional.getFactory().Core().createConditional();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtConstructor(final spoon.reflect.declaration.CtConstructor c) {
		spoon.reflect.declaration.CtConstructor aCtConstructor = c.getFactory().Core().createConstructor();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T extends java.lang.Enum<?>> void visitCtEnum(final spoon.reflect.declaration.CtEnum ctEnum) {
		spoon.reflect.declaration.CtEnum aCtEnum = ctEnum.getFactory().Core().createEnum();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtExecutableReference(final spoon.reflect.reference.CtExecutableReference reference) {
		spoon.reflect.reference.CtExecutableReference aCtExecutableReference = reference.getFactory().Core().createExecutableReference();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtField(final spoon.reflect.declaration.CtField f) {
		spoon.reflect.declaration.CtField aCtField = f.getFactory().Core().createField();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtEnumValue(final spoon.reflect.declaration.CtEnumValue enumValue) {
		spoon.reflect.declaration.CtEnumValue aCtEnumValue = enumValue.getFactory().Core().createEnumValue();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtThisAccess(final spoon.reflect.code.CtThisAccess thisAccess) {
		spoon.reflect.code.CtThisAccess aCtThisAccess = thisAccess.getFactory().Core().createThisAccess();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtAnnotationFieldAccess(final spoon.reflect.code.CtAnnotationFieldAccess annotationFieldAccess) {
		spoon.reflect.code.CtAnnotationFieldAccess aCtAnnotationFieldAccess = annotationFieldAccess.getFactory().Core().createAnnotationFieldAccess();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtFieldReference(final spoon.reflect.reference.CtFieldReference reference) {
		spoon.reflect.reference.CtFieldReference aCtFieldReference = reference.getFactory().Core().createFieldReference();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtInterface(final spoon.reflect.declaration.CtInterface intrface) {
		spoon.reflect.declaration.CtInterface aCtInterface = intrface.getFactory().Core().createInterface();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtInvocation(final spoon.reflect.code.CtInvocation invocation) {
		spoon.reflect.code.CtInvocation aCtInvocation = invocation.getFactory().Core().createInvocation();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtLocalVariable(final spoon.reflect.code.CtLocalVariable localVariable) {
		spoon.reflect.code.CtLocalVariable aCtLocalVariable = localVariable.getFactory().Core().createLocalVariable();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtLocalVariableReference(final spoon.reflect.reference.CtLocalVariableReference reference) {
		spoon.reflect.reference.CtLocalVariableReference aCtLocalVariableReference = reference.getFactory().Core().createLocalVariableReference();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtCatchVariable(final spoon.reflect.code.CtCatchVariable catchVariable) {
		spoon.reflect.code.CtCatchVariable aCtCatchVariable = catchVariable.getFactory().Core().createCatchVariable();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtCatchVariableReference(final spoon.reflect.reference.CtCatchVariableReference reference) {
		spoon.reflect.reference.CtCatchVariableReference aCtCatchVariableReference = reference.getFactory().Core().createCatchVariableReference();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtMethod(final spoon.reflect.declaration.CtMethod m) {
		spoon.reflect.declaration.CtMethod aCtMethod = m.getFactory().Core().createMethod();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtAnnotationMethod(spoon.reflect.declaration.CtAnnotationMethod annotationMethod) {
		spoon.reflect.declaration.CtAnnotationMethod aCtAnnotationMethod = annotationMethod.getFactory().Core().createAnnotationMethod();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtNewArray(final spoon.reflect.code.CtNewArray newArray) {
		spoon.reflect.code.CtNewArray aCtNewArray = newArray.getFactory().Core().createNewArray();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtConstructorCall(final spoon.reflect.code.CtConstructorCall ctConstructorCall) {
		spoon.reflect.code.CtConstructorCall aCtConstructorCall = ctConstructorCall.getFactory().Core().createConstructorCall();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtNewClass(final spoon.reflect.code.CtNewClass newClass) {
		spoon.reflect.code.CtNewClass aCtNewClass = newClass.getFactory().Core().createNewClass();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtLambda(final spoon.reflect.code.CtLambda lambda) {
		spoon.reflect.code.CtLambda aCtLambda = lambda.getFactory().Core().createLambda();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T, E extends spoon.reflect.code.CtExpression> void visitCtExecutableReferenceExpression(final spoon.reflect.code.CtExecutableReferenceExpression expression) {
		spoon.reflect.code.CtExecutableReferenceExpression aCtExecutableReferenceExpression = expression.getFactory().Core().createExecutableReferenceExpression();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T, A extends T> void visitCtOperatorAssignment(final spoon.reflect.code.CtOperatorAssignment assignment) {
		spoon.reflect.code.CtOperatorAssignment aCtOperatorAssignment = assignment.getFactory().Core().createOperatorAssignment();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtParameter(final spoon.reflect.declaration.CtParameter parameter) {
		spoon.reflect.declaration.CtParameter aCtParameter = parameter.getFactory().Core().createParameter();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtParameterReference(final spoon.reflect.reference.CtParameterReference reference) {
		spoon.reflect.reference.CtParameterReference aCtParameterReference = reference.getFactory().Core().createParameterReference();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <R> void visitCtReturn(final spoon.reflect.code.CtReturn returnStatement) {
		spoon.reflect.code.CtReturn aCtReturn = returnStatement.getFactory().Core().createReturn();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <S> void visitCtSwitch(final spoon.reflect.code.CtSwitch switchStatement) {
		spoon.reflect.code.CtSwitch aCtSwitch = switchStatement.getFactory().Core().createSwitch();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T, S> void visitCtSwitchExpression(final spoon.reflect.code.CtSwitchExpression switchExpression) {
		spoon.reflect.code.CtSwitchExpression aCtSwitchExpression = switchExpression.getFactory().Core().createSwitchExpression();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtIntersectionTypeReference(final spoon.reflect.reference.CtIntersectionTypeReference reference) {
		spoon.reflect.reference.CtIntersectionTypeReference aCtIntersectionTypeReference = reference.getFactory().Core().createIntersectionTypeReference();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtTypeReference(final spoon.reflect.reference.CtTypeReference reference) {
		spoon.reflect.reference.CtTypeReference aCtTypeReference = reference.getFactory().Core().createTypeReference();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtTypeAccess(final spoon.reflect.code.CtTypeAccess typeAccess) {
		spoon.reflect.code.CtTypeAccess aCtTypeAccess = typeAccess.getFactory().Core().createTypeAccess();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtUnaryOperator(final spoon.reflect.code.CtUnaryOperator operator) {
		spoon.reflect.code.CtUnaryOperator aCtUnaryOperator = operator.getFactory().Core().createUnaryOperator();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtVariableRead(final spoon.reflect.code.CtVariableRead variableRead) {
		spoon.reflect.code.CtVariableRead aCtVariableRead = variableRead.getFactory().Core().createVariableRead();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtVariableWrite(final spoon.reflect.code.CtVariableWrite variableWrite) {
		spoon.reflect.code.CtVariableWrite aCtVariableWrite = variableWrite.getFactory().Core().createVariableWrite();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtCodeSnippetExpression(final spoon.reflect.code.CtCodeSnippetExpression expression) {
		spoon.reflect.code.CtCodeSnippetExpression aCtCodeSnippetExpression = expression.getFactory().Core().createCodeSnippetExpression();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	public <T> void visitCtUnboundVariableReference(final spoon.reflect.reference.CtUnboundVariableReference reference) {
		spoon.reflect.reference.CtUnboundVariableReference aCtUnboundVariableReference = reference.getFactory().Core().createUnboundVariableReference();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtFieldRead(final spoon.reflect.code.CtFieldRead fieldRead) {
		spoon.reflect.code.CtFieldRead aCtFieldRead = fieldRead.getFactory().Core().createFieldRead();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtFieldWrite(final spoon.reflect.code.CtFieldWrite fieldWrite) {
		spoon.reflect.code.CtFieldWrite aCtFieldWrite = fieldWrite.getFactory().Core().createFieldWrite();
	...
	// auto-generated, see spoon.generating.CloneVisitorGenerator
	@java.lang.Override
	public <T> void visitCtSuperAccess(final spoon.reflect.code.CtSuperAccess f) {
		spoon.reflect.code.CtSuperAccess aCtSuperAccess = f.getFactory().Core().createSuperAccess();
