...
public abstract class Substitution {
	 ...
	 */
	static void insertAllSuperInterfaces(CtType targetType, Template<?> template, CtClass sourceClass) {
 ...
 * 		to be insterted nested type
	 ...
	 */
	public static <T> CtConstructor insertConstructor(CtClass targetClass, Template<?> template, CtMethod sourceMethod) {
	 ...
	 * @return the generated method
	 */
	public static <T> CtMethod insertMethod(CtType targetType, Template<?> template, CtMethod sourceMethod) {
	...
	public static <T> CtConstructor insertConstructor(CtClass targetClass, Template<?> template, CtConstructor sourceConstructor) {
	...
	public static <E extends CtElement> E substitute(CtType targetType, Template<?> template, E code) {
		...
		return ((E) (tb.substituteSingle(targetType, spoon.reflect.declaration.CtElement.class)));
	}
	 ...
	 */
	public static <T> CtField insertField(CtType targetType, Template<?> template, CtField sourceField) {
	 ...
	 */
	public static <T> CtClass getTemplateCtClass(Factory factory, Template<?> template) {
	...
	private static <T> void checkTemplateContracts(CtClass c) {
